...
echo "Enter IP"
read ipaddress
ssh root@$ipaddress 'echo "Free disk space"; df -h | grep "/dev/vd*"; 
...
cat /var/www/*/data/www/*/bitrix/license_key.php | grep -h "LICENSE_KEY" '

echo "licensekey"
read LICENSE_KEY
curl https://aspro.ru/support/key_info.php?key=$LICENSE_KEY
